...
const query = "SELECT Id, Name, Title__c, User_Story2__c,Primary_Track__c, Acceptance_Criteria__c, Primary_Track__r.Name, Requirement_Status__c, Functional_Area__c, LastModifiedDate, Development_Status__c, Development_Sprint__c, Development_Owner__c, Development_Owner__r.Name FROM Requirements__c where Primary_Track__c != 'a0r9E0000054HMPQA2' ORDER BY Name";
...
function createRecordInJira(sfRecordId, recordExists, jiraIssueKey, callback) {
    ...
    if (!recordExists) {
        ...
        jiraIssue.fields.summary = sfData.Name + "-"+ sfData.Title__c;
	   ...
	   if(sfData.Primary_Track__c!=null)
        ...
        jiraIssue.issue.fields.summary = sfData.Name + "-"+ sfData.Title__c;
